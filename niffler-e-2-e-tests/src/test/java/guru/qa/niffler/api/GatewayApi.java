...
public interface GatewayApi {
    ...
    @GET("api/friends/all")
    Call<List<UserdataUserJson>> allFriends(@Header("Authorization") String bearerToken,
    ...
    Call<UserdataUserJson> sendInvitation(@Header("Authorization") String bearerToken,
                                  @Body FriendJson friend);

    @POST("api/invitations/accept")
    Call<UserdataUserJson> acceptInvitation(@Header("Authorization") String bearerToken,
                                    @Body FriendJson friend);

    @POST("api/invitations/decline")
    Call<UserdataUserJson> declineInvitation(@Header("Authorization") String bearerToken,
                                     @Body FriendJson friend);
    ...
    Call<List<SpendJson>> allSpends(@Header("Authorization") String bearerToken,
                                    ...
                                    @Query("filterPeriod") @Nullable DataFilter filterPeriod);
    ...
    Call<UserdataUserJson> currentUser(@Header("Authorization") String bearerToken);

    @GET("api/users/all")
    Call<List<UserdataUserJson>> allUsers(@Header("Authorization") String bearerToken,
                                  @Query("searchQuery") @Nullable String searchQuery);

    @POST("api/users/update")
    Call<UserdataUserJson> updateUser(@Header("Authorization") String bearerToken,
